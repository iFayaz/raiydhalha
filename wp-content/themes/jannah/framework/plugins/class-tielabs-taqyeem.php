...
if( ! class_exists( 'TIELABS_TAQYEEM' )){
	...
	class TIELABS_TAQYEEM{
		...
		function review_rich_snippet( $schema ){
			...
			// Check if the current post has review and the Taqyeem version is >= 2.3.0
			if( ! tie_get_postdata( 'taq_review_position' ) || ! function_exists( 'taqyeem_review_get_rich_snippet' ) ){
				return $schema;
			}
