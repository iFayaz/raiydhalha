...
if( tie_get_postdata( 'tie_hide_share_'.$share_position ) == 'no' ||
	...
	$post_title   = str_replace( '%26%238216%3B', '%E2%80%99', $post_title );
	$post_title   = str_replace( '%26%238217%3B', '%E2%80%99', $post_title );
	$post_title   = str_replace( '%26%238221%3B', '%E2%80%9d', $post_title );
	$share_class  = '';
